...
class ChromeDriver:
    ...
    def _get_background_js(self, proxy_ip, proxy_port, proxy_user, proxy_password):
        background_js = """
        var config = {
                mode: "fixed_servers",
                rules: {
    ...
    def inicializar_driver(self, download_dir, headless=True, proxy=None):
        try:
...
if __name__ == '__main__':
    ...
    driver = chrome_driver.inicializar_driver('resources/downloads')
